      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu" style="border-radius: 8px; overflow: hidden;">
            ...
            <li class="user-footer" style="background: #f8f9fa;">
              <div class="pull-left">
                <a href="#profile" data-toggle="modal" class="btn btn-default btn-flat" id="admin_profile" style="background: linear-gradient(135deg, #FFD700, #FFA500); color: #006400; border: none; font-weight: bold;">
                  <i class="fa fa-user"></i> Profile
                </a>
              </div>
              <div class="pull-right">
                <a href="logout.php" class="btn btn-default btn-flat" style="background: linear-gradient(135deg, #006400, #228B22); color: white; border: none; font-weight: bold;">
